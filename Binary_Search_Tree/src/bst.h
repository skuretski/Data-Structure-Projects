...
/* function used to compare two TYPE values to each other, define this in compare.c file */
int compare(TYPE left, TYPE right);
/* function used to print TYPE values, define this in compare.c file */
void print_type(TYPE curval);


struct BSTree;
/* Declared in the source file to hide the structure members from the user. */
